...
wosc24_subtheme_type.name, absrev.remarks as remarks, absrev.reviewdesp as description
...
?>
            ...
            <form id="regis3" name="regis3" enctype="multipart/form-data" method="post">
                <table>
                    ...
                    <tbody>
                        ...
                        <!-- <tr id="abstract-id" style="display: none" class="alt">
                            <td>Abstract ID <font color="red">*</font>
                            </td>
                            <td>
                                <input type="text" name="abs_id" id="abstract-id" size="35" maxlength="25">
                            </td>
                        </tr> -->
                            ...
                            <td>
                                <div class="multiselect" id="countries" multiple="multiple" data-target="multi-0" >
                                    <div class="title noselect">
                                        <span style="display: none;" id="registration_no"><?php echo $_SESSION['id']; ?></span>
                                        <span id="abs_list" name="abs_list" class="text">Select</span>
                                        <span class="close-icon">&times;</span>
                                        <span class="expand-icon">&plus;</span>
                                    </div>
                                    <div id="abs_container" class="container">
                                    </div>
                                </div>clickadd
                            </td>
                        </tr> -->
    ...
    <h3 style="color:red;text-align:center"><b>Note</b>:-1.  Please ensure that you are paying the Overall Amount, which includes GST !</h3>
    <h3 style="color:red;text-align:center">  2.  After the payment has been completed successfully, kindly provide the correct transaction details for the verification process !</h3>
    <h3 style="color:red;text-align:center">  3.  If you are making the payment through the QR Code/UPI then kindly enter UTR Number and for internet banking kindly enter the transaction number !</h3>
                    ...
                    <tr>
                        ...
                        <td colspan="10">
                            ...
                            &nbsp; &nbsp;<input type="radio" name="acc_radio" value="no" id="acc_no"
                                onClick='set_radio(<?php echo $registration_id?>, "ACC", "acc_loader")'><label for="acc_no">No</label>
                    ...
                    <tr>
                        <td>
                            ...
                            <div class="tooltip">
                                ...
                                <span class="tooltiptext">An ECOP is a person that self identifies as being early in their carrer, within ten years or less of professional experience any field related to the ocean.</span>
                            </div>
                        </td>
                        <td colspan="10">
                            ...
                            &nbsp; &nbsp;<input type="radio" name="ecop_radio" value="no" id="ecop_no"
                                onClick='set_radio(<?php echo $registration_id?>, "ECOP", "ecop_loader")'><label for="ecop_no">No</label>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td colspan="4" id="total_amt_paid" style="color:#f113ab;font-weight:bold;">
                            &#8377; <?php if(isset($amount_paid['totalamount']))echo $amount_paid['totalamount']; else echo "0.0";?></td>
                    </tr>
    ...
    goToTab3();
    <?php } else { echo "document.getElementById('wish').innerHTML = 'Thank You!'"; } ?>
    // addOnAbsRecord();
    ...
    <?php 
    $temp = $_SESSION['active_tab'];
    $temp2 = $_SESSION['accommodation'];
    $temp3 = $_SESSION['ecop'];
    echo "console.log('temp=$temp');";
    echo "console.log('temp2=$temp2');";
    echo "console.log('temp3=$temp3');";
    if($_SESSION['active_tab']=='travel') {
        echo "goToTab3();";
    } else if($_SESSION['active_tab']=='payment') {
        echo "goToTab4();";
    } 
    ?>
