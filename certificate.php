...
$query = "select fullname from wosc24_registration
            where serial_no='$user_id'";

$result=pg_query($conn, $query);

$participant_name = pg_fetch_assoc($result)['fullname'];
