        ...
        <div class="datagrid" style="width: 780px">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="pincode" id="pincode" maxlength="75" size="35" required></td>
                </tr>
                <tr class="alt">
                ...
                <tr>
                    ...
                    <br><font id="dob_alert" color="#a7166d">(Age must be atleast 18 years old)</font>
                    </td>
                </tr>
                <tr class="alt">
            ...
            if ($existing_email) {
                ...
                if (validate_input($user_data)) {
                    ...
                    (sTitle, fullname, address, city, state, country, pincode,
                     ...
                     mode_of_participation, travel_support)
                    ...
                    $res = pg_query_params($conn, $insert_query, array(
                        ...
                        $user_data['user_type2'], $user_data['yesno']));
    ...
    <script>
        ...
        function validate_password(elem) {
            ...
            if(!myInput.match(numbers)){
                error += "\n password must contain atleast 2 digits";
                flag = 0;
        ...
        function validateBirthday(elem) {
            ...
            if (diffInYears >= 18) {
                ...
                dob_alert.innerHTML = "&#x274c; Age is not 18 years old";
            }
        }
